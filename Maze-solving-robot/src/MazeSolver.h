...
#define COUNTS_PER_CELL 600L    // Encoder counts for 18cm (1 cell) - MEASURE THIS!

// --- PD Wall Following constants ---
const float KP = 3.5; // Proportional gain (tune this)
const float KD = 0.001; // Derivative gain (tune this)
